...
// Permite alterar o índice da próxima palavra a ser destacada
export const newWordAtom = atom(-1);

// Átomo somente para escrita, atualiza o índice da palavra destacada
export const nextWordAtom = atom(null, (get, set) => {
    ...
    set(currentWordAtom, (prev) => {
        // Sobrescrever o novo índice da palavra com qualquer valor em `newWordAtom`
